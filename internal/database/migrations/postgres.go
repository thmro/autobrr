...
=======
	migrate.AddFileMigration("75_add_filter_max_downloads_interval.sql")
	migrate.AddFileMigration("76_add_filter_max_downloads_window_type.sql")
>>>>>>> 24a8224f (Adds rolling window functionality)
